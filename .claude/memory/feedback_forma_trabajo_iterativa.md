...
**How to apply:**
- **Trabajo exclusivo en `develop`**: todo el trabajo de código, tests, commits y pushes se realiza en la rama `develop`.
- **Merge a `main` y despliegue a producción**: NUNCA hacer merge a `main` ni rebuild en el NAS de forma automática o desatendida. Solo realizar el merge a `main` y deploy al NAS cuando Pedro lo solicite explícitamente (ej: "haz merge y despliega").
